...
export default function CardGridSection({ children, title }) {
  ...
  return (
    <div className="mb-10 flex flex-col gap-3 p-2">
      ...
      <div className="grid items-stretch gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
        {children}
      </div>
      <div>
        <button className="flex w-fit items-center justify-center rounded-md bg-gradient-to-br from-pink-500 to-orange-500 px-2 py-[5px] hover:from-orange-500 hover:to-pink-500 dark:border-drkbrd dark:bg-drkbg dark:text-white">
          <p className="text-xs tracking-wide text-white xs:text-lg 2xl:text-base">
            &nbsp;See all
          </p>
        </button>
      </div>
